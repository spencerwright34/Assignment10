...
namespace Assignment10
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
            //End point
            endpoints.MapControllerRoute("bowlingteampagenum",
                "TeamName/{bowlingteamid}/{teamname}/{pagenum}",
                new { Controller = "Home", action = "Index" });

            endpoints.MapControllerRoute("bowlingteamid",
                "TeamName/{bowlingteamid}/{teamname}",
